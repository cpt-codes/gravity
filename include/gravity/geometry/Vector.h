...
namespace gravity::geometry
{
    ...
    /// Returns @c true if any of the vector's elements are less than the
    /// scalar, @c false otherwise.
    ...
    /// Returns @c true if any of the vector's elements are less than or equal
    /// to the scalar, @c false otherwise.
    template<arithmetic T>
